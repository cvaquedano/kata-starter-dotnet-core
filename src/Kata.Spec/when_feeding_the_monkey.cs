...
namespace Kata.Spec
{
    ...
    public class when__input_empty_string
    {
    ...
    public class when_input_new_lime_delimter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_Input_one_negative_number
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();    
    ...
    public class when_input_multi_negative_numbers
    {
        Establish _context = () => { _systemUnderTest = new Calculator(); };

        Because of = () => { _result = Catch.Exception( () =>_systemUnderTest.Add("1,-2,-3,5")); };
        It should_throw_an_exception = () => { _result.Should().Be("negatives not allowed: -2, -3"); };
        static Calculator _systemUnderTest;
        static Exception _result;
    };
}
