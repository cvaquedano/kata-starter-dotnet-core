...
namespace Kata.Spec
{
    ...
    public class when_input_is_tow_numbers
    {
        Establish _context = () =>
        {
        ...
        It should_sum_the_two_numbers = () => { _result.Should().Be(3); };
        static Calculator _systemUnderTest;
        static int _result;
    }
    ...
    public class when_new_line_and_comma_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_one_negative_number
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        It should_return_an_exceptiion = () => { _result.Message.Should().Be("negatives not allowed: -2"); };
